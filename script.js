...
const messages = [
    'امروز از همون اول گفتم این دستو نزن 😂',
    'بچه ها کسی این راندو دید؟',
    'من یه کم بالا بودم دوباره همه چی برگشت سر جاش 😐',
    'داداش این یکی واقعا نزدیک بود',
    'کسی میدونه راند بعدی کی شروع میشه؟',
    'من فعلا با مبلغ کم میرم جلو ببینم چی میشه',
    'عه اینو دیگه فکر نمیکردم 😳',
    'امروز اصلا با من راه نمیاد',
    'یکی نتیجه رو بگه من ندیدم چی شد',
    'من این دستو رد کردم خوب شد 😂',
    'بچه ها موجودی منو نبینید بهتره',
    'این یکی خیلی بد دراومد',
    'گفتم صبر کن ولی گوش نکردم 😅',
    'کسی امروز برد خوبی داشته؟',
    'من یه مقدار گرفتم بیرون، دیگه دست نمیزنم',
    'داداش چرا انقدر عجله میکنی؟',
    'این راند کلا عجیب بود',
    'من دیگه امشب ادامه نمیدم',
    'یکی بگه الان وضعیت چطوره',
    'امروز دو بار نزدیک بود همه چی برگرده',
    'من فعلا فقط دارم نگاه میکنم 👀',
    'عههه این یکی خوب نشست',
    'نه دیگه، اینجا دیگه باید میرفتم بیرون',
    'کسی هنوز داره بازی میکنه؟',
    'من گفتم این دست ریسکیه',
    'امروز شانس با من قهره 😂',
    'یه دست دیگه میبینم بعد میبندم',
    'اینم از شانس ما',
    'بچه ها آروم تر برید جلو',
    'من یه برد کوچیک گرفتم راضیم ❤️',
    'این یکی اصلا طبق چیزی که فکر میکردم نشد',
    'داداش من دیگه دنبال جبران نیستم',
    'راند آخر خیلی نزدیک بود',
    'کسی امروز از اول خوب پیش رفته؟',
    'من فعلا همون مبلغ کم رو نگه میدارم',
    'واسه امشب دیگه بسه',
    'عه برد شد 😳',
    'این یکی واقعا غافلگیرم کرد',
    'من دیگه خارج شدم، موفق باشید ✌️'
];
